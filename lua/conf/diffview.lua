...
require("diffview").setup({
    ...
    keymaps = {
        ...
        view = { -- The `view` bindings are active in the diff buffers, only when the current
        ...
        file_history_panel = {{"n", "g!", actions.options, {
        ...
        option_panel = {{"n", "<tab>", actions.select_entry, {
